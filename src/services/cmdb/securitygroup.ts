...
export async function securitygroupReadOneApiCmdbSecuritygroupsByUid(
  ...
  return request<CMDB.SecurityGroupReadOneResp>(
    `/api/cmdb/securitygroups/${param0}`,
    {
      method: "GET",
      params: { ...queryParams },
      ...(options || {}),
...
export async function securitygroupUpdateApiCmdbSecuritygroupsByUid(
  ...
  const { uid: param0, ...queryParams } = params
  return request<CMDB.SecurityGroupUpdateResp>(
    `/api/cmdb/securitygroups/${param0}`,
    {
      method: "PUT",
      headers: {
...
export async function securitygroupDeleteApiCmdbSecuritygroupsByUid(
  ...
  const { uid: param0, ...queryParams } = params
  return request<CMDB.SecurityGroupDeleteResp>(
    `/api/cmdb/securitygroups/${param0}`,
    {
      method: "DELETE",
      headers: {
...
export async function securitygroupOptionsApiCmdbSecuritygroupsOptions(
  ...
  return request<CMDB.SecurityGroupOptionsResp>(
    "/api/cmdb/securitygroups/options",
    {
      method: "GET",
      params: {
        ...params,
