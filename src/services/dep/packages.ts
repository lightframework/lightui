...
/** 获取commitId GET /api/dep/packages/commitid */
export async function packagesCommitIdApiDepPackagesCommitid(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: DEP.packagesCommitIdApiDepPackagesCommitidParams,
  options?: { [key: string]: any },
) {
  return request<DEP.PackagesCommitIdResp>("/api/dep/packages/commitid", {
    method: "GET",
    params: {
      ...params,
    },
