...
import { alertFilterAtom, showGridAtom } from "../_atoms"
...
export default function AlertFilter() {
  ...
  return (
    <div className="flex items-center gap-2">
      <Button icon={<AppstoreOutlined />} onClick={() => setShowGrid(true)} />
      <Button
          ...
          setAlertFilter({
            ...
            stime:
              values.timeBefore !== 0
                ...
                : Math.floor(
                    new Date(
                      values.timeRange![0].toISOString() ?? "",
                    ).getTime() / 1000,
                  ),
            etime:
              values.timeBefore !== 0
                ...
                : Math.floor(
                    new Date(
                      values.timeRange![1].toISOString() ?? "",
                    ).getTime() / 1000,
                  ),
          })
        }}
