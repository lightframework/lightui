...
import { domainsetUpdateInfoApiOpsDomainsetsByInfoid } from "@/services/ops/domainset"
import { Button, Drawer, Form, message, Radio, Select } from "antd"
import { useId } from "react"

type FormValues = OPS.DomainsetUpdateInfoReq
const FormItem = Form.Item<FormValues>

export interface DomainSetBaseUpdateFormDrawerProps {
...
export default function DomainSetBaseUpdateFormDrawer({
  domainSet,
  open,
  onClose,
  onFinish,
}: DomainSetBaseUpdateFormDrawerProps) {
  const id = useId()
    ...
    >
      <Form<FormValues>
        ...
        onFinish={async (values) => {
          await domainsetUpdateInfoApiOpsDomainsetsByInfoid(
            { id: domainSet!.id.toString() },
            values,
          )
