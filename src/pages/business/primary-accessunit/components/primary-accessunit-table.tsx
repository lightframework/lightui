...
import UsageIpsetTable from "./usage-ipset-table"
...
export default function PrimaryAccessUnitTable() {
    ...
    <>
      ...
      <PrimaryAccessUnitDetailsDrawer
        ...
        onClickRelatedAuCount={
          currentAu ? () => showRelatedAus(currentAu) : undefined
        }
      />
