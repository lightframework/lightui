...
import DomainsetInfoModal from "../../domainset/_components/domainset-info-modal"
...
export default function UsageDomainsetTable({ ids }: { ids: number[] }) {
  ...
  return (
    <>
      <Table
        name="usage-domainset"
        actionRef={tableRef}
        columns={columns}
        rowKey="id"
        searchPlaceholder="请输入名称/域名查询"
        params={{ envUid, tags: tags?.join(","), ids: ids.join(",") }}
